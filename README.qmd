...
-   Commencez par rechercher les éléments intéressants (indices) dans la référence fournie dans le dossier `bibliography` et prenez note de l'endroit où ils se trouvent. Recherchez au moins un indice différent pour chaque étudiant et attribuez-vous à chacun un indice à présenter et à calculer.
